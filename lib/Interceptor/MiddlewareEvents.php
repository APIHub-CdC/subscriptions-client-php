...
namespace CirculoDeCredito\Subscriptions\Client\Interceptor;
...
use \CirculoDeCredito\Subscriptions\Client\Interceptor\KeyHandler;
use \CirculoDeCredito\Subscriptions\Client\Interceptor\MyLogger;
use \CirculoDeCredito\Subscriptions\Client\Model\Errors;
use \CirculoDeCredito\Subscriptions\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(\CirculoDeCredito\Subscriptions\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new \CirculoDeCredito\Subscriptions\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new \CirculoDeCredito\Subscriptions\Client\Model\Errores(["errors" => [$error]]);
